...
\section{3.4.2 Multiple Unaligned Equations}
...
\section{3.4.3 Multiple Aligned Equations}
...
\begin{align}
  \sum_{k=0}^n k 
  &= \sum_{k=0}^{n-1} k + n && \text{definition}\\
  &= \frac{n(n-1)}{2}  + n && \text{introduction}\\
  &= \frac{n(n-1)}{2} && \text{trivial}
\end{align}
...
\section{3.4.4 Equations as Building Blocks}
...
\section{3.4.5 IEEEequnarry Environment}
